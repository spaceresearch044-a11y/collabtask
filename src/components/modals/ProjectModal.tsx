...
export const ProjectModal: React.FC<ProjectModalProps> = ({
  ...
  useEffect(() => {
    if (project && mode === 'edit') {
      setFormData({
        ...
        project_type: project.project_type || 'individual',
        deadline: project.deadline ? project.deadline.split('T')[0] : '',
        team_code: project.team_code || '',
  ...
  const getModalTitle = () => {
    ...
    if (mode === 'quickAdd') return 'Quick Add Project'
    return step === 1 ? 'Create New Project' : 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <Card className="p-6 space-y-6" glow>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <h3 className="font-semibold text-white mb-1">Individual</h3>
              ...
              {/* Step 2: Project Details */}
              {(step === 2 || mode === 'edit' || mode === 'quickAdd') && (
                <motion.div
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
                  className="space-y-4"
                >
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      {loading ? 'Creating...' : mode === 'edit' ? 'Update Project' : 'Create Project'}
                    </Button>
                  </div>
                </motion.div>
              )}
