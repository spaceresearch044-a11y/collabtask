...
export const TaskBoard3D: React.FC = () => {
  ...
  const tasks: Task[] = [
    { id: '1', title: 'Design Homepage', status: 'in_progress', priority: 'high', assignee: 'Sarah Chen' },
    { id: '2', title: 'API Integration', status: 'todo', priority: 'medium', assignee: 'Alex Rodriguez' },
    { id: '3', title: 'User Testing', status: 'review', priority: 'high', assignee: 'Emma Wilson' },
    { id: '4', title: 'Deploy Production', status: 'completed', priority: 'urgent', assignee: 'Mike Johnson' },
    { id: '5', title: 'Database Schema', status: 'in_progress', priority: 'medium', assignee: 'Lisa Park' },
    { id: '6', title: 'Mobile Responsive', status: 'todo', priority: 'low', assignee: 'David Kim' },
    { id: '7', title: 'Security Audit', status: 'todo', priority: 'urgent', assignee: 'Sarah Chen' },
    { id: '8', title: 'Performance Optimization', status: 'review', priority: 'medium', assignee: 'Alex Rodriguez' },
  ]
